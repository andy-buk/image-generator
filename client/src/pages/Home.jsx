...
const RenderCards = ({ data, title }) => {
  ...
  return (
    <h2 className='mt-5 font-bold text-[#86c232] text-xl uppercase'>
      {title}
    </h2>
  );
};
    ...
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font-extrabold text-[#86c232] text-[32px]'>
          The AI-Inspired Visual Odyssey
        </h1>
        <p className='mt-2 text-white text-[16px] max-w-[500px]'>
        Step into the world of AI and discover an eclectic array of visuals brought to life by DALL-E.
        </p>
      </div>
          ...
          <>
            {searchText && (
              <h2 className='font-medium text-white text-xl mb-3'>
                Showing results for <span className='text-[#86c232]'>
                  {searchText}
                </span>
              </h2>
            )}
